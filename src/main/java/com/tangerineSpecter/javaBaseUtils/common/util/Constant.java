...
public class Constant {
     ...
     * 工具类全限定名头
     */
    public static final String UTIL_QUALIFIED_HEAD = "com.tangerinespecter.javabaseutils.common.util.";

    /**
     * 工具类绝对路径
     */
    public static final String UTIL_ABSOLUTE_PATH = System.getProperty("user.dir") + "/src/main/java/com/tangerinespecter/javabaseutils/common/util";
